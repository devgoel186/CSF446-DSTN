...
class Disk:
    ...
    def LSTFHelper(self, rList):
        maxDist = 0
        maxBlock = sys.maxsize
        trackList = []
...
parser.add_option('-p', '--policy',          default='FIFO',
                  help='Scheduling policy (FIFO, SSTF, SATF, BSATF, SCAN)',             action='store', type='string', dest='policy')
